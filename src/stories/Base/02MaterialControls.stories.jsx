...
import { MaterialControls } from "./02MaterialControls";

export default {
  title: "Basis/MaterialControls",
...
export const MaterialControlss = MaterialControlsLate.bind({});
//参数
